...
const AppFeatures = () => {
  return (
    <motion.section
      ...
      className="relative z-10 w-full bg-black py-16 overflow-hidden"
    >
      ...
      <div className="relative z-10 container mx-auto p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px]">
        ...
        >
          <div className="bg-white/5 border border-white/10 p-8 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-accent text-white px-8 py-3 rounded-lg font-medium hover:bg-accent-hover transition-all duration-300">
                Download for iOS
              </button>
              <button className="bg-white text-black px-8 py-3 rounded-lg font-medium hover:bg-gray-200 transition-all duration-300">
