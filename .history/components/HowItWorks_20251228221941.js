  ...
  return (
    <section className="relative z-10 w-full bg-white overflow-hidden">
      <div className="container mx-auto py-20 px-5 md:px-[5%] 2xl:px-0 max-w-[1400px]">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <video
                  ...
                  muted
                  playsInline
                  className="w-full max-w-sm lg:max-w-md h-auto drop-shadow-lg rounded-3xl"
                />
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="inline-block bg-accent/5 border border-accent/20 rounded-lg px-8 py-4">
