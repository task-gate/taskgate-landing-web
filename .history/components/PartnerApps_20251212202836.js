...
const partnerApps = [
  {
    ...
    description: "Practice affirmations and manifestation exercises before app access",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {partnerApps.map((app, index) => (
            <motion.div
              ...
              className="group relative p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-accent/50 hover:bg-white/10 transition-all duration-300"
            >
              <div
