    ...
    >
      <div className="container mx-auto p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px]">
        <div className="text-center mb-12">
          ...
          >
            Discover how TaskGate transforms impulsive app opens into opportunities 
            for mindfulness, learning, and intentional digital habits.
          </motion.p>
        </div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-lg">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Join thousands who are using TaskGate to build healthier digital habits 
