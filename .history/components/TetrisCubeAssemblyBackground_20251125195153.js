  ...
  useEffect(() => {
    ...
    const createFallingPiece = (pieceData, startTime) => {
      ...
      if (pieceData.type === "cube") {
        ...
        const pyramidGeom = new THREE.ConeGeometry(tailBaseSize / 2, tailHeight, 4);
        mesh = new THREE.Mesh(pyramidGeom, tailMaterial.clone());
        // Rotate so it points in -X direction (tail behind body)
        mesh.rotation.z = Math.PI / 2;
        mesh.rotation.y = Math.PI / 4; // Align square base
      }
