      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Join these amazing apps already integrated with TaskGate, helping users build better habits every day.
            </p>
          </motion.div>
            ...
            {currentPartners.map((app, index) => (
              ...
              >
                <a
                  ...
                  className={`block p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-accent/50 hover:bg-white/10 transition-all duration-300 ${app.link ? 'cursor-pointer' : ''}`}
                >
                  <div
