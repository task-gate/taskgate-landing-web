          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10">
                <div className="text-4xl font-bold bg-gradient-to-r from-accent to-purple-600 bg-clip-text text-transparent mb-2">10K+</div>
                <div className="text-gray-400">Active Users</div>
              </div>
              <div className="text-center p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10">
                <div className="text-4xl font-bold bg-gradient-to-r from-accent to-purple-600 bg-clip-text text-transparent mb-2">100K+</div>
                <div className="text-gray-400">Tasks Completed</div>
              </div>
              <div className="text-center p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10">
                <div className="text-4xl font-bold bg-gradient-to-r from-accent to-purple-600 bg-clip-text text-transparent mb-2">95%</div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-r from-accent/20 to-purple-600/20 border border-accent/30 rounded-2xl p-12 text-center"
          >
