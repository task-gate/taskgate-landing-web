...
const benefits = [
  {
    icon: (
      <div className="w-14 h-14 rounded-full bg-gradient-to-r from-accent to-purple-600 flex items-center justify-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10">
                <div className="text-4xl font-bold bg-gradient-to-r from-accent to-purple-600 bg-clip-text text-transparent mb-2">
                  10K+
                </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <div className="mb-12 flex justify-center max-w-3xl mx-auto">
              <Image
                src="/mock/mock10.png"
