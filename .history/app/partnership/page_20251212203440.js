...
const benefits = [
  {
    ...
    description: "Connect with users actively building better digital habits and looking for productive alternatives to mindless scrolling.",
  },
  {
    icon: <TrendingUp className="w-8 h-8 text-accent" />,
    title: "Increase User Acquisition",
    description: "Get discovered by TaskGate users at the perfect moment—when they're ready to replace impulsive behavior with meaningful action.",
  },
  {
    icon: <Code className="w-8 h-8 text-accent" />,
    title: "Simple Integration",
    description: "Our deep link API makes integration straightforward. Minimal technical overhead with maximum impact.",
  },
  {
    icon: <Shield className="w-8 h-8 text-accent" />,
    title: "Privacy-First Approach",
    description: "We respect user privacy and don't share personal data. Partners receive usage analytics without compromising user trust.",
  },
];
...
const howItWorks = [
  {
    ...
    description: "Connect your app using our simple deep link protocol. Users complete mini-tasks from your app before accessing gated apps.",
  },
  {
    step: "2",
    title: "Users Discover Your App",
    description: "TaskGate users encounter your app as a task option, trying it naturally as part of their habit-building routine.",
  },
  {
    step: "3",
    title: "Seamless Experience",
    description: "After completing your task, users are automatically redirected back to their desired app—creating a smooth, frustration-free flow.",
  },
  {
    step: "4",
    title: "Track & Optimize",
    description: "Monitor engagement metrics and optimize your task offerings to maximize user acquisition and retention.",
  },
];
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white leading-tight">
              Grow Your App with{" "}
              <span className="text-accent">TaskGate</span>
            </h1>
