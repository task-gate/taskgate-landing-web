            ...
            {currentPartners.map((app, index) => (
              ...
              >
                <a
                  ...
                  className={`block p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-accent/50 hover:bg-white/10 transition-all duration-300 ${
