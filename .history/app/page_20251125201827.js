...
import SlidingCubeGridBackground from "@/components/SlidingCubeGridBackground";
import TetrisCubeAssemblyBackground from "@/components/TetrisCubeAssemblyBackground";
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <it’s like a 3D sliding-puzzle wall 🧊

Below is a full React + Three.js component that creates:

A wall of cubes (8×5 grid by default)

A few empty spaces in the wall

Cubes keep sliding into a neighboring empty space in 3D

Gentle camera orbit + nice lighting

Background-style component (fixed, pointer-events: none) />
          {/* <TetrisCubeAssemblyBackground /> */}
        </div>
