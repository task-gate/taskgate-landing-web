    ...
    >
      ...
      <div className="mx-auto px-5 md:px-[5%] 2xl:px-0 pb-20 container max-w-[1200px]">
        <article className="flex flex-col gap-5">
          ...
          <p className="text-base">
            TaskGate is a Law of Attraction and conscious digital living tool
            that helps users transform digital distractions into manifestation
          ...
          <p className="text-base">
            ...
            and display mindful prompts. These permissions are used only to show
            affirmations or pause screens — TaskGate does not access or read
            your personal data, messages, or browsing history.
          </p>
          ...
          <ul className="list-disc list-inside text-base ml-4">
            ...
            <li>
              The suitability of TaskGate for your specific goals or mental
              wellness outcomes
            </li>
          </ul>
          <p className="text-base">
            TaskGate is a self-reflection and mindfulness tool, not a substitute
