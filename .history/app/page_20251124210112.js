    ...
    <>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <h1 className="relative text-5xl md:text-7xl lg:text-8xl font-bold mb-4 leading-tight">
                <span className="block text-white mb-2">Break the Cycle of</span>
            ...
            >
              ...
              <div className="relative bg-white/5 backdrop-blur-lg border border-white/20 rounded-2xl p-8 shadow-2xl">
                <p className="text-lg md:text-xl text-white/90 leading-relaxed font-medium">
                  ...
                  {" "}before access is granted. Choose from built-in mini-tasks like breathing exercises, 
                  reflections, and flashcards—or connect with partner apps for even more variety.
                </p>
          ...
          >
            <div className="text-center p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10">
              ...
              <p className="text-gray-300">
                TaskGate catches impulsive app opens before they happen, 
                giving you a moment to pause and reflect.
              </p>
            </div>
            <div className="text-center p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10">
              ...
              <p className="text-gray-300">
                Complete short activities like breathing exercises, 
                journal prompts, or partner app challenges to earn access.
              </p>
            </div>
            <div className="text-center p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            Most app usage is impulsive—you reach for your phone without thinking. 
            TaskGate adds intentionality by requiring a small commitment before 
            access. Whether it's a breathing exercise, a reflection, or a partner app's 
            challenge, you'll build healthier digital habits one task at a time.
          </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            ...
            >
              ...
              <p className="text-gray-700">
                You tap Instagram or TikTok without thinking, losing minutes 
                (or hours) to endless scrolling and distraction.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
            ...
            >
              ...
              <p className="text-gray-800">
                ...
                gives you the choice—continue with purpose or redirect your time.
              </p>
            </motion.div>
          </div>
        </div>
