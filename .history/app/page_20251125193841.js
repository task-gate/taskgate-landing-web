...
import ImpossibleRotationBackground from "@/components/ImpossibleRotationBackground";
...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        {/* Sliding Cube Grid Background */}
        <div className="absolute inset-0 z-0">
          <SlidingCubeGridBackground />
          <ImpossibleRotationBackground />
        </div>
