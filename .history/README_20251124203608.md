...
**TaskGate** is a revolutionary mobile app that applies the Law of Attraction to your digital habits. By intercepting app usage and showing personalized affirmation screens, TaskGate helps users transform mindless scrolling into conscious manifestation moments. This landing page project uses Firebase for data storage (waitlist sign-ups and contact form submissions) and provides a user-friendly interface for exploring the app's manifestation-focused features.
